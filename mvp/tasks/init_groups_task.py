...
class InitGroupsTask:
    def run(self):
        ...
        # user role with same permissions as owner (for now)
        user_group, created = Group.objects.get_or_create(name=OrgRole.USER)
        ...
        for group in (owner_group, user_group):
            group.permissions.add(can_edit_members)
            group.permissions.add(can_edit_organization)
            group.permissions.add(can_view_ai_code_monitor)
            group.permissions.add(can_view_compass_budget)
            group.permissions.add(can_view_compass_compliance)
            group.permissions.add(can_view_compass_dashboard)
            group.permissions.add(can_view_compass_integrations)
            group.permissions.add(can_view_compass_assign_git_setup)
            group.permissions.add(can_view_compass_organization_users)
            group.permissions.add(can_get_compass_document)
            group.permissions.add(can_list_compass_documents)
            group.permissions.add(can_upload_compass_documents)
            group.permissions.add(can_view_compass_organization_developer_groups)
            group.permissions.add(can_view_compass_organization_repository_groups)
            group.permissions.add(can_view_compass_projects)
            group.permissions.add(can_make_compass_projects_chat_input)
            group.permissions.add(can_set_compass_insights_notifications)
            group.permissions.add(can_view_compass_roadmap)
            group.permissions.add(can_view_compass_team)
            group.permissions.add(can_view_pull_request_scans)
            group.permissions.add(can_view_compliance_standards)
            group.permissions.add(can_view_insights)
            group.permissions.add(can_edit_settings)
            group.permissions.add(can_edit_connections)
